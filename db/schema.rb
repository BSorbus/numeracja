...
ActiveRecord::Schema.define(version: 2019_03_19_005214) do
  ...
  create_table "aus_tables", force: :cascade do |t|
    ...
    t.index ["change_date"], name: "index_aus_tables_on_change_date"
  ...
  create_table "ispc_tables", force: :cascade do |t|
    ...
    t.string "location"
    t.datetime "change_date"
    t.index ["change_date"], name: "index_ispc_tables_on_change_date"
  ...
  create_table "mnc_tables", force: :cascade do |t|
    ...
    t.string "network"
    t.datetime "change_date"
    t.index ["change_date"], name: "index_mnc_tables_on_change_date"
  ...
  create_table "nds_tables", force: :cascade do |t|
    ...
    t.string "operator_name"
    t.datetime "change_date"
    t.index ["change_date"], name: "index_nds_tables_on_change_date"
  ...
  create_table "ndsi_tables", force: :cascade do |t|
    ...
    t.datetime "change_date"
    t.index ["change_date"], name: "index_ndsi_tables_on_change_date"
  ...
  create_table "nrnp_tables", force: :cascade do |t|
    ...
    t.string "operator_name"
    t.datetime "change_date"
    t.index ["change_date"], name: "index_nrnp_tables_on_change_date"
  ...
  create_table "nspc_tables", force: :cascade do |t|
    ...
    t.string "operator_name"
    t.datetime "change_date"
    t.index ["change_date"], name: "index_nspc_tables_on_change_date"
  ...
  create_table "pstn_tables", force: :cascade do |t|
    ...
    t.datetime "change_date"
    t.index ["change_date"], name: "index_pstn_tables_on_change_date"
